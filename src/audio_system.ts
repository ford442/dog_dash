...
export class AudioSystem {
    ...
    // -------------------------------------------------------------------------
    // GRAVITY HUM — persistent resonance layer driven by proximity + angular speed
    // -------------------------------------------------------------------------

    /**
     * Start the gravity hum voice.  Safe to call multiple times — idempotent.
     * Call once when the player first enters any gravity anchor's field.
     */
    ...
    /**
     * Update pitch and volume of the gravity hum in real-time.
     * Call every frame while the player is inside a gravity anchor's field.
     *
     * @param distance     Distance from player to nearest anchor centre (world units).
     * @param angularSpeed Current angular speed of the player around the anchor (rad/s).
     */
    ...
    /**
     * Fade out and release the gravity hum voice.
     * Call when the player exits all gravity fields.
     */
    stopGravityHum(): void {
    ...
    // -------------------------------------------------------------------------
    // GRAVITY SLING RELEASE — doppler-ish whoosh on clean arc exit
    // -------------------------------------------------------------------------

    /**
     * Play a gravity-sling release whoosh.  The character changes based on
     * release quality ('perfect' | 'good' | 'ok') and the current combo count.
     *
     * @param quality  How clean the sling arc was.
     * @param combo    Current sling combo count (affects pitch ceiling and extra layers).
     */
