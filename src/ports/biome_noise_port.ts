 ...
 * Backed by the WASM `fractalNoise2D` export (`assembly/noise.ts`, built by
 * default — see docs/WASM_BACKENDS.md) when a handle is bound; otherwise a
 * JS value-noise fallback. Never throws — always returns a stable value in
